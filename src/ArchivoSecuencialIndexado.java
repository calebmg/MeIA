...
import java.util.stream.Stream;import java.io.BufferedReader;
...
class ArchivoSecuencialIndexado {
        ...
        if (Retornar == true) {
            ...
            if (Archivo.exists()) {
                ...
                if (TotalRegistros < MaxRegistros) {
                    ...
                    Actual++;
                    return HayEspacio(("C:\\MEIA\\Desc_Donaciones_" + Actual + ".txt"), Retornar, Usuario);
                }
            } else {
                ...
                String pathDescDonaciones = "C:\\MEIA\\Desc_Donaciones_" + Actual + ".txt";
                ...
                if (descDonaciones.exists()) {
                    ...
                    writer5.write("Nombre del archivo:Donaciones_" + Actual);
                    writer5.write("\nUsuario Creador:" + Usuario);
                    writer5.write("\nFecha de Creación:" + Fecha);
                    writer5.write("\nTotal Registros:0");
                    writer5.write("\nRegistros Activos:0");
                    writer5.write("\nRegistros Inactivos:0");
                    String NuevoMax = ObtenerLinea(7, ("C:\\MEIA\\Desc_Donaciones_" + (Actual - 1) + ".txt"));
                    String[] NuevoMax2 = NuevoMax.split(":");
                    writer5.write("\nMax para Reorganizar:" + NuevoMax2[1]);
                    writer5.close();
                }
                String pathDonaciones = "C:\\MEIA\\Donaciones_" + Actual + ".txt";
    ...
    public void Insertar(String Usuario, String Fecha, String Nombre_Material, Integer Peso, String Descripcion,
        ...
        String ArchivoDisponible = HayEspacio(("C:\\MEIA\\Desc_Donaciones_" + Actual + ".txt"), false, Usuario_transaccion);
        File ArchivoMaestro = new File("C:\\MEIA\\Donaciones_" + Actual + ".txt");
        ...
        String LineaBuscar = Usuario + "," + Nombre_Material + "," + Fecha + "," + Peso + "," + Descripcion + ","
                + Evento + "," + Usuario_transaccion + "," + FechaCreacion + "," + 1;
        writer7.close();
        Integer N = ObtenerNumeroLinea(LineaBuscar, ("C:\\MEIA\\Donaciones_" + Actual + ".txt"));
